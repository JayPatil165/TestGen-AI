"""C# Test Runner (NUnit/xUnit/MSTest)."""
...
class CSharpTestRunner(BaseTestRunner):
    """Test runner for C# projects using dotnet test."""
    ...
    def count_tests(self, test_dir: str, pattern: Optional[str] = None) -> int:
        ...
        for test_file in test_files:
            try:
                ...
                total += content.count("[Test]") + content.count("[Fact]")
            except:
                pass
        return total
    ...
    def validate_test_file(self, test_file: str) -> bool:
        try:
            ...
            return '[Test]' in content or '[Fact]' in content
        except:
            return False
